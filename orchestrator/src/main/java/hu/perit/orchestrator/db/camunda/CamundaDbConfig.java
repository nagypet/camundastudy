...
package hu.perit.orchestrator.db.camunda;
...
@EnableJpaRepositories(basePackages = CamundaDbConfig.PACKAGES, //
    entityManagerFactoryRef = CamundaDbConfig.ENTITY_MANAGER_FACTORY, //
    transactionManagerRef = CamundaDbConfig.TRANSACTION_MANAGER)
@Slf4j
public class CamundaDbConfig
{
    static final String PACKAGES = "hu.perit.orchestrator.db.camunda";
    ...
    public static final String PERSISTENCE_UNIT = "camunda";
    private static final String DATASOURCE = "dataSource";

    private final ConnectionParam connectionParam;

    public CamundaDbConfig(DatasourceCollectionProperties dbProperties)
    {
