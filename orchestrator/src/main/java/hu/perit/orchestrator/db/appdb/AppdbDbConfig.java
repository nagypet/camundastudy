...
package hu.perit.orchestrator.db.appdb;
...
@EnableJpaRepositories(basePackages = AppdbDbConfig.PACKAGES, //
    entityManagerFactoryRef = AppdbDbConfig.ENTITY_MANAGER_FACTORY, //
    transactionManagerRef = AppdbDbConfig.TRANSACTION_MANAGER)
@EnableJpaAuditing(auditorAwareRef = "auditorProvider")
@Slf4j
public class AppdbDbConfig
{
    static final String PACKAGES = "hu.perit.orchestrator.db.appdb";
    static final String ENTITY_MANAGER_FACTORY = "appdbEntityManagerFactory";
    static final String TRANSACTION_MANAGER = "appdbTransactionManager";

    public static final String PERSISTENCE_UNIT = "appdb";
    private static final String DATASOURCE = "appdbDataSource";

    private final ConnectionParam connectionParam;

    public AppdbDbConfig(DatasourceCollectionProperties dbProperties)
    {
