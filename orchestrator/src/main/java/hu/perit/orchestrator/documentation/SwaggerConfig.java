...
package hu.perit.orchestrator.documentation;
...
public class SwaggerConfig {
	...
	private static final Contact DEFAULT_CONTACT = new Contact(
			"Peter Nagy", "https://github.com/nagypet/redisstudy", "nagy.peter.home@gmail.com");

	private static final ArrayList<VendorExtension> VENDOR_EXTENSIONS = new ArrayList<>();

	private static final ApiInfo DEFAULT_API_INFO = new ApiInfo(
			"Camundastudy",
			"This is an sample project for demonstrating the Camunda workflow engine",
			"1.0",
			"urn:tos",
			DEFAULT_CONTACT,
